...
import com.example.nombi.warframebuild.ModFragment.OnListFragmentInteractionListener;
...
public class MyModRecyclerViewAdapter extends RecyclerView.Adapter<MyModRecyclerViewAdapter.ViewHolder> {
    ...
    public MyModRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
